...
export class Gearman {
  ...
  shutdown () {
    this.gear.disconnect();
  }

  // priority can be null (normal) or 'high' or 'low'

  async request (method, params = {}, { priority = null, dedupe = null, meta = null } = {}) {
  ...
  async notify (method, params = {}, { priority = null, dedupe = null, meta = null } = {}) {
